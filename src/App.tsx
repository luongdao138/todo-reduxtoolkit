  ...
  return (
    <div className='bg-slate-200 min-h-screen py-4'>
      ...
      >
        <TodoDetail
          selectedItem={selectedItem}
          onCloseModal={handleCloseTodoDetail}
        />
      </Modal>
      <div style={{ width: '550px' }} className='m-auto'>
        ...
        {!selectedTodos.length ? (
          <div className='flex items-center justify-between'>
            ...
            <div>
              ...
              <button className='px-4 py-2 mr-2 rounded-md bg-gray-500 text-white'>
                To do trash
              </button>
          ...
          <div className='flex items-center gap-4'>
            <div className='flex-1'>
              <button className='px-4 mr-2 py-2 rounded-md bg-red-500 text-white'>
                Delete
              </button>
              <button className='px-4 py-2 rounded-md bg-amber-600 text-white'>
                Permanent Delete
              </button>
            </div>
            <button
        ...
        {!todos.length ? (
          <p className='text-center text-3xl font-medium mt-8'>
